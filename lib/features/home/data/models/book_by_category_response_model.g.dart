...
part of 'book_by_category_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BookByCategoryResponseModel _$BookByCategoryResponseModelFromJson(
        Map<String, dynamic> json) =>
    BookByCategoryResponseModel(
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => BookItemsByCategory.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$BookByCategoryResponseModelToJson(
        BookByCategoryResponseModel instance) =>
    <String, dynamic>{
      'items': instance.items,
    };

BookItemsByCategory _$BookItemsByCategoryFromJson(Map<String, dynamic> json) =>
    BookItemsByCategory(
...
Map<String, dynamic> _$BookItemsByCategoryToJson(
        BookItemsByCategory instance) =>
    <String, dynamic>{
      'id': instance.id,

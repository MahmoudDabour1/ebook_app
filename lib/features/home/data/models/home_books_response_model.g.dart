...
part of 'home_books_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HomeBooksResponseModel _$HomeBooksResponseModelFromJson(
        Map<String, dynamic> json) =>
    HomeBooksResponseModel(
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => BookItems.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$HomeBooksResponseModelToJson(
        HomeBooksResponseModel instance) =>
    <String, dynamic>{

...
class BooksByCategoryBlocBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeCubit,HomeState>(
        buildWhen: (previous, current) =>
            current is BookByCategoryLoading || current is BookByCategorySuccess|| current is BookByCategoryError,
  ...
  Widget setupSuccess( bookByCategoryList) {
    return CategoryResponseListView(booksItemsByCategory: bookByCategoryList??[],);
  }
